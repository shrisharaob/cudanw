...
#define K_FF_I_PREFACTOR  1.0 //0.50 // alpha_I

#define K_REC_E_PREFACTOR K_REC_I_PREFACTOR // beta_E
#define K_FF_E_PREFACTOR  1.0 //0.5 // 1.0 //K_FF_I_PREFACTOR // alpha_E
...
#define STORE_LAST_T_MILLISEC 5000.0 // for voltage
